...
const storage = multerS3({
  ...
  bucket: function (req, file, cb) {
    const directory = `${bucketName}/uploads/customers/business/logo`;
    cb(null, directory);
  },
...
const importFileUploadCustomerBusinessLogo = multer({
  storage: storage,
  limits: { fileSize: 1024 * 1024 * maxFileUploadSize },
  fileFilter: fileFilter,
});
export { importFileUploadCustomerBusinessLogo };
