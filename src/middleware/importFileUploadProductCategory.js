...
const storage = multerS3({
  ...
  bucket: function (req, file, cb) {
    const directory = `${bucketName}/uploads/product/category`;
    cb(null, directory);
  },
...
const maxFileUploadSize = envs.maxFileUploadSize ? envs.maxFileUploadSize : 10;
...
const importFileUploadProductCategory = multer({
  storage: storage,
  limits: { fileSize: 1024 * 1024 * maxFileUploadSize },
  fileFilter: fileFilter,
});
export { importFileUploadProductCategory };
